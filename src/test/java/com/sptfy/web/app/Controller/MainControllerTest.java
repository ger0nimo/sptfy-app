...
////        mainController.setAuthenticatedUser(this.authenticatedUser);
//        mockMvc = MockMvcBuilders.standaloneSetup(mainController).setControllerAdvice(new ControllerExceptionHandler()).apply(SecurityMockMvcConfigurers.springSecurity()).build();
